...
formalization of the spectral NS scheme: \textbf{120 proved theorems across 8 files}
...
Tao's averaging breaks. The hierarchy theorem
...
\textbf{120 proved theorems across 8 files} (0 sorries, 2 honest axioms),
totalling \textbf{4208 lines}:
\begin{itemize}
...
stretching identity---is now formalized in Lean, totalling 120
theorems across 8 files with 0 sorries.
