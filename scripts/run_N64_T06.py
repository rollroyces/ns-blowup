"""Extend N=64 nu=0.001 Hou-Luo IC run to T_final=0.06 (1200 steps).

Reuses hou_luo_style_ic() and the spectral helpers. Records (times,
max_omega) every step. The T=0.04 slice will be identical to the existing
ns_run_N64_nu0.001_T04.npz (same IC, same dt).

Run:
    source /Users/hermes/.hermes/projects/ns_blowup/venv/bin/activate
    cd /Users/hermes/.hermes/projects/ns_blowup
    python scripts/run_N64_T06.py
"""
import sys, time, os
import numpy as np
import torch
...
AMP = 10.0
SIGMA_Z = 0.5
N_STEPS = int(round(T_FINAL / DT))   # 1200

OUT = "/Users/hermes/.hermes/projects/ns_blowup/data/ns_run_N64_nu0.001_T06.npz"
...
print()
print("=" * 60)
print("Results — Case A: N=64, nu=0.001")
print("=" * 60)
